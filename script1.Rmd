...
base <- ggplot(data = data, ylim = c(0,200000), aes(x=Last_Update, 
 ...
 geom_text(aes(x = as.Date("2020-04-12"), y = 8631, label = "Toplam İyileşen", color = "Recovered")) + 
geom_text(aes(x = as.Date("2020-04-12"), y = 1643, label = "Toplam Ölüm", color = "Deaths"))
