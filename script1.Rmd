...
Dünya genelinde `r Sys.Date()` tarihinden bu yana Covid-19 tespit edilen vaka sayısı `r covid_cases_total` olmuştur. .

Dünya genelinde `r Sys.Date()` tarihinden bu yana Covid-19'dan ölen toplam kişi sayısı `r covid_death_total` olmuştur. 

Türkiye genelinde `r Sys.Date()` tarihinden bu yana Covid-19 tespit edilen vaka sayısı `r covid_cases_tr` olmuştur. 

Türkiye genelinde `r Sys.Date()` tarihinden bu yana Covid-19'dan ölen toplam kişi sayısı `r covid_death_tr` olmuştur. 
...
group_by(countriesAndTerritories) %>%
summarise(Toplam_Vaka = sum(cases)) %>%
ggplot(aes(countriesAndTerritories)) +
