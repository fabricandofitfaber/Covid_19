...
Türkiye genelinde Covid-19 tespit edilen vaka sayısı `r covid_cases_tr` olmuştur. `Sys.Date()`.

Türkiye genelinde Covid-19'dan ölen toplam kişi sayısı `r covid_death_tr` olmuştur. `Sys.Date()`.
